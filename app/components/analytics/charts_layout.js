        ...
        <div className="chart-navigation">
          ...
          <div className="row justify-content-center">
            <div className="col-3 timestamp">
              <button
                className="btn btn-default btn-icon icon-lg btn-chart-prev fa fa-chevron-left fa-2x"
              ...
              />
              <button
                className="btn btn-default btn-icon icon-lg btn-chart-next fa fa-chevron-right fa-2x"
