  ...
  render() {
    ...
    return (
      <div>
        ...
        <Row className="fieldgroup">
          <Col xs="4" className="fieldname"><FormattedMessage id={ `${prefix}.postDecimalPosition` }/></Col>
          <Col xs="8" className="grey-underline fieldvalue">{ register.postDecimalPosition }</Col>
        </Row>
        <Row className="fieldgroup">
          <Col xs="4" className="fieldname"><FormattedMessage id={ `${prefix}.preDecimalPosition` }/></Col>
          <Col xs="8" className="grey-underline fieldvalue">{ register.preDecimalPosition }</Col>
        </Row>
        <Row className="fieldgroup">
