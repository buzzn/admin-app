...
const LCPContract = ({ url, contract, prefix, contractor, intl, handleSubmit, editMode, switchEditMode }: Props & InjectedIntlProps) => (
        ...
        <Row>
          <Col xs="12">
            <h5 className="grey-underline mt-5 pb-2">
              ...
              {!editMode &&
                contract.updatable && <i data-cy="group edit switch" className="buzzn-pencil" style={{ float: 'right' }} onClick={switchEditMode} />}
            </h5>
            ...
            <TwoColView {...{ prefix, field: 'thirdPartyBillingNumber' }}>
            ...
            <TwoColView {...{ prefix, field: 'beginDate' }}>
...
export default reduxForm({ form: 'LCPUpdateForm', enableReinitialize: true })(injectIntl(withEditOverlay(LCPContract)));
